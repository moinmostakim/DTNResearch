...
public class MessageDeleteEvent extends MessageEvent {
	...
	public void processEvent(World world) {
		DTNHost host = world.getNodeByAddress(this.getFromAddr());
		
		if (getId().equals(StandardEventsReader.ALL_MESSAGES_ID)) {
			...
			host.deleteMessage(getId(), drop);
		}
	}

	@Override
	public String toString() {
		return super.toString() + " [" + getFromAddr() + "] DELETE";
	}
