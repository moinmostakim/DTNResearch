...
public abstract class MessageRouter {
	...
	public void init(DTNHost host, List<MessageListener> mListeners) {
            this.setIncomingMessages(new HashMap<String, Message>());
            this.setMessages(new HashMap<String, Message>());
            this.setDeliveredMessages(new HashMap<String, Message>());
		this.setBlacklistedMessages(new HashMap<String, Object>());
	...
	public boolean hasMessage(String id) {
		return this.getMessages().containsKey(id);
	}
	...
	protected boolean isDeliveredMessage(Message m) {
		return (this.getDeliveredMessages().containsKey(m.getId()));
	}
	...
	protected boolean isBlacklistedMessage(String id) {
		return this.getBlacklistedMessages().containsKey(id);
	}
	...
	public Collection<Message> getMessageCollection() {
		return this.getMessages().values();
	}
	 ...
	 */
		...
		this.getIncomingMessages().put(m.getId() + "_" + from.toString(), m);
	}
	...
	protected Message removeFromIncomingBuffer(String id, DTNHost from) {
		return this.getIncomingMessages().remove(id + "_" + from.toString());
	}
	...
	protected boolean isIncomingMessage(String id) {
		return this.getIncomingMessages().containsKey(id);
	}
	 ...
	 * message, if false, nothing is informed.
		...
		this.getMessages().put(m.getId(), m);
	...
	protected Message removeFromMessages(String id) {
		Message m = this.getMessages().remove(id);
		return m;
	}
	...
	public RoutingInfo getRoutingInfo() {
		...
		RoutingInfo incoming = new RoutingInfo(this.getIncomingMessages().size() + 
				" incoming message(s)");
		RoutingInfo delivered = new RoutingInfo(this.getDeliveredMessages().size() +
				" delivered message(s)");
		...
		for (Message m : this.getIncomingMessages().values()) {
     ...
     */
    public void setIncomingMessages(HashMap<String, Message> incomingMessages) {
    ...
    /**
     * @param deliveredMessages the deliveredMessages to set
     */
    public void setDeliveredMessages(HashMap<String, Message> deliveredMessages) {
        this.deliveredMessages = deliveredMessages;
    }

    /**
     * @return the blacklistedMessages
     */
    ...
    /**
     * @param blacklistedMessages the blacklistedMessages to set
     */
    public void setBlacklistedMessages(HashMap<String, Object> blacklistedMessages) {
