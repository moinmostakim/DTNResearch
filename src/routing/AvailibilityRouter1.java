 ...
 * @author samsung
 */
public class AvailibilityRouter1 extends ActiveRouter {

    
    
    Map<DTNHost, Double> lastSeen = new HashMap<>();

    public AvailibilityRouter1(Settings s) {
        super(s);
    }

    protected AvailibilityRouter1(AvailibilityRouter1 ar) {

        super(ar);
    }

    @Override
    public AvailibilityRouter1 replicate() {

        return new AvailibilityRouter1(this);
    }
