...
public class Path {
    ...
    public Coord getNextWaypoint() {
        assert hasNext() : "Path didn't have " + (getNextWpIndex() + 1) + ". waypoint";
    ...
    public boolean hasNext() {
        return getNextWpIndex() < this.coords.size();
    }
    ...
    public double getSpeed() {
        ...
        assert getNextWpIndex() != 0 : "No waypoint asked";

        if (speeds.size() == 1) {
            return speeds.get(0);
        } else {
            return speeds.get(getNextWpIndex() - 1);
        }
    }
    ...
    /**
     * @return the nextWpIndex
     */
    public int getNextWpIndex() {
        return nextWpIndex;
    }

    /**
     * @param nextWpIndex the nextWpIndex to set
     */
    public void setNextWpIndex(int nextWpIndex) {
        this.nextWpIndex = nextWpIndex;
    }
}
